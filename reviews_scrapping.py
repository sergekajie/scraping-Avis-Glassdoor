...
def get_all_reviews(n_pages=config.n_pages, logger=config.get_logger("main")):
    """
    Return all reviews
    ...
    for i in range(1, n_pages + 1):
        logger.info(f"Page {i} : https://www.glassdoor.fr/Avis/TNP-Consultants-Avis-E455516_P{i}.htm?filter.iso3Language=fra")
